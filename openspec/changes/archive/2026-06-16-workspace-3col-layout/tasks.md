...
- [x] 5.3 用户实测确认：用户已完成多轮模拟器/截图验收并要求先收尾；拖动手感/不闪由人工验收覆盖，残余风险写入验证报告
- [x] 5.4 真机验收（follow-up，沿用 v1/change1 延期约定；2026-06-16 已构建并安装到真机，启动因 iPad 尚未信任开发者 profile 被系统拒绝，后续信任后继续人工查看）
